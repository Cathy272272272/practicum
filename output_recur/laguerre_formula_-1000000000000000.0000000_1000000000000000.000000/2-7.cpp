...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  ( cbrt( (  ( x*x ) * ( 10.5+ ( -5.833333*x )  )  ) )*cbrt( (  ( x*x ) * ( 10.5+ ( -5.833333*x )  )  ) ) ) *cbrt( (  ( x*x ) * ( 10.5+ ( -5.833333*x )  )  ) ) ) + (  ( x*-7.0 ) +1.0 )  ) + (  (  (  ( x*x ) * ( x*x )  ) * ( 1.458333+ ( -0.175*x )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) *cbrt(pow( ( x*x ) ,3)) ) * (  ( -0.000198*x ) +0.009722 )  )  )  ) ;
	#endif
	OFT outv = rel;
