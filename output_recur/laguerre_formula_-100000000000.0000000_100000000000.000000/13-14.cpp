...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  ( x*x ) * ( x*x )  ) * (  (  (  ( x*-9e-06 ) +0.000276 ) * ( pow(x,3)*pow(x,3) )  ) + ( pow(x,4)* ( 0.074479+ ( -0.005517*x )  )  )  )  ) + (  (  ( 1.0+ ( x*-14.0 )  ) + (  ( pow(x,3)*pow(x,3) ) * ( 4.170833+ ( x*-0.680952 )  )  )  ) + (  (  (  ( x*-16.683333 ) +41.708333 ) * (  ( x*x ) * ( x*x )  )  ) + (  (  ( -60.666667*x ) +45.5 ) * ( x*x )  )  )  )  ) ;
	#endif
	OFT outv = rel;
