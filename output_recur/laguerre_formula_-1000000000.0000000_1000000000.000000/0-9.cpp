...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  (  (  ( 1.0+ ( -9.0*x )  ) + ( 18.0* ( x*x )  )  ) + ( -14.0* (  ( x*x ) *x )  )  ) +cbrt(pow( ( pow(x,3)* ( 5.25*x )  ) ,3)) ) + ( -1.05* (  (  (  ( x*x ) *x ) *x ) *x )  )  ) + ( 0.116667* (  (  (  (  ( x*x ) *x ) *x ) *x ) *x )  )  ) + ( -0.007143* (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 0.000223* (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -3e-06* (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
