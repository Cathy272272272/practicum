...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( pow(x,3)*pow(x,3) ) *x ) * ( pow(x,3)* (  ( x*-2e-06 ) +7.9e-05 )  )  ) + (  ( pow(x,4)* (  ( x*x ) * ( x*x )  )  ) * ( 0.03192+ ( -0.00197*x )  )  )  ) + (  (  ( 1.0+ ( x*-13.0 )  ) + (  ( pow(x,3)*pow(x,3) ) * ( 2.383333+ ( x*-0.340476 )  )  )  ) + (  (  (  ( x*-10.725 ) +29.791667 ) * (  ( x*x ) * ( x*x )  )  ) + (  (  ( -47.666667*x ) +39.0 ) * ( x*x )  )  )  )  ) ;
	#endif
	OFT outv = rel;
