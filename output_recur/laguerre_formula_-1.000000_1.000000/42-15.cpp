...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( x*-15.0 ) +exp(log( (  ( x*x ) * ( 52.5- ( 75.833333*x )  )  ) )) ) + (  (  ( pow(x,3)*pow(x,3) ) * (  ( x*-1.276786 ) +6.951389 )  ) +1.0 )  ) + (  ( pow(x,3)*pow(x,3) ) * (  (  ( 0.000828+ ( -3.4e-05*x )  ) * (  ( x*x ) * ( x*x )  )  ) + (  ( 1e-06* ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  )  )  ) + (  (  (  ( 0.159598+ ( x*-0.013792 )  ) *pow(x,4) ) + ( 56.875+ ( -25.025*x )  )  ) * (  ( x*x ) * ( x*x )  )  )  ) ;
	#endif
	OFT outv = rel;
