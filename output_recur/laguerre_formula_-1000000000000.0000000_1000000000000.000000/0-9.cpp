...
int main (int argc, char *argv[]) {
    ...
    FT x;
	#ifdef ORIG
	rel = __libcpp_generalized_laguerre_recurrence(9, x);
	#else
	rel =  (  (  (  (  (  (  (  (  ( 1.0+ ( -9.0*x )  ) + ( sqrt( ( 18.0* ( x*x )  ) )*sqrt( ( 18.0* ( x*x )  ) ) )  ) + ( -14.0* (  ( x*x ) *x )  )  ) + ( 5.25* (  (  ( x*x ) *x ) *x )  )  ) + ( -1.05* (  (  (  ( x*x ) *x ) *x ) *x )  )  ) + ( 0.116667* (  (  (  (  ( x*x ) *x ) *x ) *x ) *x )  )  ) + ( -0.007143* (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 0.000223* (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -3e-06* (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
