...
function end(x) {
	return (((((x * x) * (x * x)) * ((((x * -2e-06) + 7.9e-05) * (math.pow(x, 3.0) * math.pow(x, 3.0))) + (math.pow(x, 4.0) * (0.03192 + (-0.00197 * x))))) + ((math.pow(x, 3.0) * math.pow(x, 3.0)) * (2.383333 + (x * -0.340476)))) + (((1.0 + (x * -13.0)) + ((39.0 + (x * -47.666667)) * (x * x))) + (((x * -10.725) + 29.791667) * math.cbrt(math.pow(x, (3.0 * (3.0 + 1.0)))))));
}
