...
function end(x) {
	return ((((((x * x) * (x * x)) * ((x * x) * (x * x))) * (0.000223 + (-3e-06 * x))) + (((x * x) * (x * x)) * ((x * x) * 0.116667))) + (((((-0.007143 * x) * (x * x)) * ((x * x) * (x * x))) + ((x * -9.0) + 1.0)) + (((x * x) * (18.0 + (x * -14.0))) + (math.exp((math.log((x * x)) + math.log((x * x)))) * ((x * -1.05) + 5.25)))));
}
