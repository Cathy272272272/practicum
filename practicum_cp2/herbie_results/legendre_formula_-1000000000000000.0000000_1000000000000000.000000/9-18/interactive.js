...
function end(x) {
	return (((((-51061.90567 + ((x * x) * 153185.71701)) * (((x * x) * (x * x)) * ((x * x) * (x * x)))) + ((31.715469 * (x * x)) + -0.185471)) + (((-888.033142 + ((x * x) * 9531.555725)) * ((x * x) * (x * x))) + ((((x * x) * 275152.766418) + -269235.502625) * math.pow(((x * x) * (x * x)), 3.0)))) + ((-151334.02153 + ((x * x) * 34618.893814)) * ((((x * x) * (x * x)) * ((x * x) * (x * x))) * (((x * x) * (x * x)) * ((x * x) * (x * x))))));
}
