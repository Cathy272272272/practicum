...
function end(x) {
	return (((((math.pow((x * x), 3.0) * ((x * x) * (x * x))) * ((x * x) * (x * x))) * (-3932160.0 + (x * (x * 65536.0)))) + ((((x * -8302694400.0) * x) + 518918400.0) + (((x * x) * (x * x)) * ((x * (-15498362880.0 * x)) + 19372953600.0)))) + (((((x * x) * (x * x)) * ((x * x) * (x * x))) * (5535129600.0 + (-984023040.0 * (x * x)))) + (math.pow(x, 12.0) * 89456640.0)));
}
