...
function end(x) {
	return ((((((x * x) * (x * x)) * math.pow(x, (2.0 + 2.0))) * ((1.8e-05 * (x * x)) + (-0.000606 * x))) + (((math.pow(x, 4.0) * 20.625) + ((x * -12.0) + 1.0)) + ((x * x) * (33.0 + (-36.666667 * x))))) + (x * ((((x * x) * (x * x)) * (-6.6 + (1.283333 * x))) + ((math.pow(x, 3.0) * math.pow(x, 3.0)) * (-0.157143 + (x * 0.012277))))));
}
