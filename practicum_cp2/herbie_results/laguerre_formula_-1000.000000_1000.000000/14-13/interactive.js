...
function end(x) {
	return ((((((x * x) * (x * x)) * (math.pow(x, 3.0) * math.pow(x, 3.0))) * (7.9e-05 + (x * -2e-06))) + ((((x * x) * (x * x)) * math.pow(x, (2.0 + 2.0))) * (0.03192 + (-0.00197 * x)))) + ((((math.pow(x, 3.0) * math.pow(x, 3.0)) * ((-0.340476 * x) + 2.383333)) + ((x * -13.0) + 1.0)) + ((((x * x) * (x * x)) * ((-10.725 * x) + 29.791667)) + ((x * x) * ((-47.666667 * x) + 39.0)))));
}
