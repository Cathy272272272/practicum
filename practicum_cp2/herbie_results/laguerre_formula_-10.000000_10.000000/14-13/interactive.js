...
function end(x) {
	return ((((((x * x) * (x * x)) * (29.791667 + (x * -10.725))) + ((math.pow(x, 3.0) * math.pow(x, 3.0)) * (2.383333 + (-0.340476 * x)))) + (((x * x) * (39.0 + (x * -47.666667))) + ((x * -13.0) + 1.0))) + ((((math.pow(x, 3.0) * math.pow(x, 3.0)) * math.pow(x, 3.0)) * (((x * x) * -2e-06) + (7.9e-05 * x))) + ((((x * x) * (x * x)) * ((x * x) * (x * x))) * ((-0.00197 * x) + 0.03192))));
}
