...
function end(x) {
	return (((((-12.0 * x) + 1.0) + (((x * -6.6) + 20.625) * ((x * x) * (x * x)))) + ((math.pow((x * x), 3.0) * (1.283333 + (x * -0.157143))) + ((x * x) * ((x * -36.666667) + 33.0)))) + ((((0.012277 + (-0.000606 * x)) * math.pow(x, 4.0)) + (((x * x) * 1.8e-05) * ((x * x) * (x * x)))) * math.pow(x, (2.0 + 2.0))));
}
