...
function end(x) {
	return ((((65536.0 * math.pow(x, 16.0)) - (3932160.0 * math.pow(x, 14.0))) + ((((math.pow(x, 4.0) * 19372953600.0) + ((x * -8302694400.0) * x)) + 518918400.0) + (math.pow((x * x), 3.0) * (-15498362880.0 + (5535129600.0 * (x * x)))))) + ((math.pow((x * x), 3.0) * ((x * x) * (x * x))) * (-984023040.0 + (x * (89456640.0 * x)))));
}
