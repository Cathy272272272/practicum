...
function end(x) {
	return ((((((-26357760.0 * x) * (x * x)) * ((x * x) * (x * x))) + (17297280.0 * x)) + ((x * x) * (((x * 69189120.0) * (x * x)) + (-69189120.0 * x)))) + (((math.pow(x, 3.0) * (math.pow(x, 3.0) * math.pow(x, 3.0))) * ((x * (x * -319488.0)) + 4392960.0)) + (math.pow(x, 13.0) * 8192.0)));
}
