...
function end(x) {
	return (((((x * (0.116667 * x)) * ((x * x) * (x * x))) + ((x * -9.0) + 1.0)) + (((x * x) * ((-14.0 * x) + 18.0)) + (((x * x) * (x * x)) * (5.25 + (-1.05 * x))))) + (x * (((math.pow(x, 3.0) * math.pow(x, 3.0)) * (-0.007143 + (x * 0.000223))) + ((-3e-06 * math.pow(x, 4.0)) * ((x * x) * (x * x))))));
}
