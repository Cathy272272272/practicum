...
function end(x) {
	return (((((x * x) * (x * x)) * (19372953600.0 + (x * (-15498362880.0 * x)))) + ((((x * x) * -8302694400.0) + 518918400.0) + (((x * x) * 5535129600.0) * math.pow((x * x), 3.0)))) + (((math.pow((x * x), 3.0) * ((x * x) * (x * x))) * (-984023040.0 + (x * (89456640.0 * x)))) + (((math.pow((x * x), 3.0) * ((x * x) * (x * x))) * ((x * x) * (x * x))) * (-3932160.0 + ((x * x) * 65536.0)))));
}
