...
function end(x) {
	return (((((x * x) * ((-36.666667 * x) + 33.0)) + ((x * -12.0) + 1.0)) + (((math.pow(x, 3.0) * math.pow(x, 3.0)) * (1.283333 + (-0.157143 * x))) + (((x * x) * (x * x)) * (20.625 + (-6.6 * x))))) + (((((x * x) * (x * x)) * ((x * x) * (x * x))) * (1.8e-05 * (x * x))) + ((((x * x) * (x * x)) * ((x * x) * (x * x))) * ((-0.000606 * x) + 0.012277))));
}
