...
function end(x) {
	return (((((math.pow(x, 3.0) * math.pow(x, 3.0)) * x) * (math.pow(x, 3.0) * ((x * -2e-06) + 7.9e-05))) + ((math.pow(x, 4.0) * ((x * x) * (x * x))) * (0.03192 + (-0.00197 * x)))) + (((1.0 + (x * -13.0)) + ((math.pow(x, 3.0) * math.pow(x, 3.0)) * (2.383333 + (x * -0.340476)))) + ((((x * -10.725) + 29.791667) * ((x * x) * (x * x))) + (((-47.666667 * x) + 39.0) * (x * x)))));
}
