...
function end(x) {
	return (((((2029.790039 * x) * x) * math.pow((x * x), 3.0)) + (((math.pow(x, 3.0) * math.pow(x, 3.0)) * ((x * x) * (x * x))) * ((x * (660.194336 * x)) + -1894.470703))) + ((((x * x) * (x * x)) * (((x * x) * -997.089844) + 219.946289)) + (((x * -17.595703) * x) + 0.225586)));
}
