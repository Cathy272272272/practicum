...
function end(x) {
	return ((((((x * x) * 5535129600.0) * math.pow((x * x), 3.0)) + (518918400.0 + ((x * x) * -8302694400.0))) + ((-3932160.0 + ((x * x) * 65536.0)) * (math.pow((x * x), 3.0) * math.pow((x * x), (3.0 + 1.0))))) + (((((x * x) * -15498362880.0) + 19372953600.0) * ((x * x) * (x * x))) + ((((x * x) * 89456640.0) + -984023040.0) * ((math.pow(x, 3.0) * (x * x)) * (math.pow(x, 3.0) * (x * x))))));
}
