...
function end(x) {
	return math.log(math.exp((1.0 * ((((-17.595703 * (x * x)) + 0.225586) + (math.pow((x * x), (1.0 + 3.0)) * (2029.790039 + (-1894.470703 * (x * x))))) + (((x * x) * (x * x)) * ((660.194336 * math.pow((x * x), (1.0 + 3.0))) + (219.946289 + (-997.089844 * (x * x)))))))));
}
