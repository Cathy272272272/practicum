...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  ( x*x ) * ( x*x )  ) * ( pow(x,3)*pow(x,3) )  ) * (  ( x*-3.4e-05 ) +0.000828 )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( 0.159598+ ( -0.013792*x )  )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * ( 56.875+ ( -25.025*x )  )  ) + (  ( pow(x,3)*pow(x,3) ) * ( 6.951389+ ( -1.276786*x )  )  )  ) + ( log(exp( (  ( x*x ) * ( 52.5+ ( -75.833333*x )  )  ) ))+ (  ( x*-15.0 ) +1.0 )  )  )  ) + (  (  ( 1e-06*x ) * ( x*x )  ) * (  ( pow(x,3)*pow(x,3) ) *pow(x,3) )  )  ) ;
	#endif
	OFT outv = rel;
