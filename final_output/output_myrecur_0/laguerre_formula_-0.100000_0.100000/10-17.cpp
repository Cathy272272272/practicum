...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  ( x*x ) * ( x*x )  ) * ( pow(x,3)*pow(x,3) )  ) * (  ( x*-0.00031 ) +0.005359 )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( 0.602927+ ( -0.066992*x )  )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * ( 99.166667+ ( -51.566667*x )  )  ) + (  ( pow(x,3)*pow(x,3) ) * ( 17.188889+ ( -3.85873*x )  )  )  ) + ( log(exp( (  ( x*x ) * ( 68.0+ ( -113.333333*x )  )  ) ))+ (  ( x*-17.0 ) +1.0 )  )  )  ) + (  (  ( 1.3e-05*x ) * ( x*x )  ) * (  ( pow(x,3)*pow(x,3) ) *pow(x,3) )  )  ) ;
	#endif
	OFT outv = rel;
