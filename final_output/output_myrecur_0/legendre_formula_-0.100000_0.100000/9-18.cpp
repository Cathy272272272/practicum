...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  ) * ( -269235.502625+ ( 275152.766418* ( x*x )  )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( -51061.90567+ ( 153185.71701* ( x*x )  )  )  )  ) + (  (  (  ( x*31.715469 ) *x ) +-0.185471 ) + (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*x ) *9531.555725 ) +-888.033142 )  )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( 34618.893814* ( x*x )  ) +-151334.02153 )  )  ) ;
	#endif
	OFT outv = rel;
