...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  ( pow( ( x*x ) ,3)* (  ( x*x ) * ( x*x )  )  ) * (  ( -984023040.0+ (  ( 89456640.0*x ) *x )  ) + (  (  (  ( 65536.0*x ) *x ) +-3932160.0 ) * (  ( x*x ) * ( x*x )  )  )  )  ) + (  ( cbrt( (  (  (  ( pow(x,3)* ( 19372953600.0*x )  ) +518918400.0 ) + (  ( -8302694400.0*x ) *x )  ) + ( pow( ( x*x ) ,3)* ( -15498362880.0+ (  ( x*x ) *5535129600.0 )  )  )  ) )*cbrt( (  (  (  (  ( x*-15498362880.0 ) *x ) +19372953600.0 ) * (  ( x*x ) * ( x*x )  )  ) + (  (  (  ( x*x ) *5535129600.0 ) *pow( ( x*x ) ,3) ) + ( 518918400.0+ (  ( -8302694400.0*x ) *x )  )  )  ) ) ) *cbrt( (  (  ( 19372953600.0- ( 15498362880.0* ( x*x )  )  ) * (  ( x*x ) * ( x*x )  )  ) + (  (  (  ( x*x ) *5535129600.0 ) *pow( ( x*x ) ,3) ) + ( 518918400.0+ (  ( -8302694400.0*x ) *x )  )  )  ) ) )  ) ;
	#endif
	OFT outv = rel;
