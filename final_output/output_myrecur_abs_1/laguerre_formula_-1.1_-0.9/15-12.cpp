...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( 1.8e-05*x ) *pow(x,3) ) * ( pow(x,3)*pow(x,3) )  ) + ( cbrt(pow(x, ( 3* ( 3+1 )  ) ))* (  ( x*-6.6 ) +20.625 )  )  ) + (  (  ( x*-0.000606 ) +0.012277 ) * (  (  ( x*x ) * ( x*x )  ) *pow(x,4) )  )  ) + (  (  ( -12.0*x ) +1.0 ) + (  (  ( pow(x,3)*pow(x,3) ) * ( 1.283333+ ( -0.157143*x )  )  ) + (  (  ( x*-36.666667 ) +33.0 ) * ( x*x )  )  )  )  ) ;
	#endif
	OFT outv = rel;
