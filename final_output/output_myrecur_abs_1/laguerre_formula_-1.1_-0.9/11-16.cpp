...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  (  ( x*-0.031526 ) +0.319196 ) + ( pow(x,3)* ( 4e-06*x )  )  )  ) + (  (  ( 75.833333+ ( -36.4*x )  ) *pow(x,4) ) + (  ( pow(x,3)*pow(x,3) ) * (  ( -2.269841*x ) +11.122222 )  )  )  ) + (  (  ( -16.0*x ) + (  ( 0.002207+ ( -0.000109*x )  ) * ( pow(x,8)* ( x*x )  )  )  ) + (  (  ( 60.0+ ( -93.333333*x )  ) * ( x*x )  ) +1.0 )  )  ) ;
	#endif
	OFT outv = rel;
