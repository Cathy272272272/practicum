...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  ( x*25.783333 ) *x ) * (  ( x*x ) * ( x*x )  )  ) + ( pow(x,6)* ( x*-6.314286 )  )  ) + (  ( pow(x,3)* ( x*127.5 )  ) + (  (  ( x*x ) * ( x*x )  ) * ( x*-71.4 )  )  )  ) + (  (  (  (  ( 3.9e-05*x ) *pow(x,3) ) *pow( ( x*x ) , ( 3+1 ) ) ) + ( pow( ( x*x ) , ( 3+1 ) )* (  ( x*-0.000797 ) * ( x*x )  )  )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x*-1e-06 ) *pow( ( x*x ) , ( 3+1 ) ) )  )  )  ) + (  (  (  (  ( -136.0*x ) * ( x*x )  ) +1.0 ) + ( x* ( -18.0+ ( 76.5*x )  )  )  ) + (  (  (  (  ( 0.012059*x ) *pow(x,3) ) * ( pow(x,3)*pow(x,3) )  ) + ( pow( ( x*x ) , ( 3+1 ) )*1.085268 )  ) + ( pow(x,8)* ( -0.133984*x )  )  )  )  ) ;
	#endif
	OFT outv = rel;
