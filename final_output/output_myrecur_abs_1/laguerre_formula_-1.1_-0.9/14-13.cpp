...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( x*x ) * ( x*x )  ) * (  (  (  ( x*-2e-06 ) +7.9e-05 ) * ( pow(x,3)*pow(x,3) )  ) + ( pow(x,4)* ( 0.03192+ ( -0.00197*x )  )  )  )  ) + (  ( pow(x,3)*pow(x,3) ) * ( 2.383333+ ( x*-0.340476 )  )  )  ) + (  (  ( 1.0+ ( x*-13.0 )  ) + (  ( 39.0+ ( x*-47.666667 )  ) * ( x*x )  )  ) + (  (  ( x*-10.725 ) +29.791667 ) *cbrt(pow(x, ( 3* ( 3+1 )  ) )) )  )  ) ;
	#endif
	OFT outv = rel;
