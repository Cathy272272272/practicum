...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = my_laguerre(9, x + 0.0);
	#else
	rel =  ( cbrt( (  (  (  (  (  ( x*x ) * ( 18.0+ ( x*-14.0 )  )  ) + (  ( -9.0*x ) +1.0 )  ) + (  (  ( -1.05+ ( 0.116667*x )  ) * ( pow(x,3)* ( x*x )  )  ) + ( pow(x,3)* ( 5.25*x )  )  )  ) * (  (  (  ( x*x ) * ( 18.0+ ( x*-14.0 )  )  ) + (  ( -9.0*x ) +1.0 )  ) + (  (  ( -1.05+ ( 0.116667*x )  ) * ( pow(x,3)* ( x*x )  )  ) + ( pow(x,3)* ( 5.25*x )  )  )  )  ) * (  (  ( -1.05+ ( 0.116667*x )  ) * ( pow(x,3)* ( x*x )  )  ) + ( sqrt( (  ( pow(x,3)* (  ( 5.25*x ) +-14.0 )  ) + (  ( 1.0+ ( -9.0*x )  ) + (  ( 18.0*x ) *x )  )  ) )*sqrt( (  ( pow(x,3)* (  ( 5.25*x ) +-14.0 )  ) + (  ( 1.0+ ( -9.0*x )  ) + (  ( 18.0*x ) *x )  )  ) ) )  )  ) )+ (  (  (  ( -0.007143*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( -3e-06*x ) +0.000223 )  )  )  ) ;
	#endif
	OFT outv = rel;
