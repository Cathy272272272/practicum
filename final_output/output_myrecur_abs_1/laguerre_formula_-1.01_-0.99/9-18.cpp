...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( pow( ( -1/x ) ,-6)* (  ( x*x ) * ( x*x )  )  ) * ( x* (  ( 3.9e-05*x ) +-0.000797 )  )  ) + (  ( pow( ( x*x ) , ( 3+1 ) )* ( x*x )  ) * (  ( x*-1e-06 ) * ( x*x )  )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*25.783333 ) *x ) + (  ( -6.314286*x ) * ( x*x )  )  )  ) + (  (  (  ( x*x ) * ( -71.4*x )  ) * ( x*x )  ) + (  ( x*127.5 ) *pow(x,3) )  )  )  ) + (  (  (  (  ( 1.0+ ( -18.0*x )  ) + ( 76.5* ( x*x )  )  ) + (  ( -136.0*x ) * ( x*x )  )  ) + ( pow(x,8)* (  ( -0.133984*x ) + (  ( x*x ) *0.012059 )  )  )  ) + ( pow( ( x*x ) , ( 3+1 ) )*1.085268 )  )  ) ;
	#endif
	OFT outv = rel;
