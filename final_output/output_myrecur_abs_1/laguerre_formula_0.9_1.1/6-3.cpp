...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = my_laguerre(3, x + 0.0);
	#else
	rel =  (  ( 1.0+ (  ( -3.0+ ( 1.5*x )  ) *x )  ) + (  (  ( cbrt( ( cbrt( ( -0.166667* (  ( x*x ) *x )  ) )*cbrt( ( -0.166667* (  ( x*x ) *x )  ) ) ) )*cbrt( ( cbrt( ( -0.166667* (  ( x*x ) *x )  ) )*cbrt( ( -0.166667* (  ( x*x ) *x )  ) ) ) ) ) *cbrt( ( cbrt( ( -0.166667* (  ( x*x ) *x )  ) )*cbrt( ( -0.166667* (  ( x*x ) *x )  ) ) ) ) ) *cbrt( ( -0.166667* (  ( x*x ) *x )  ) ) )  ) ;
	#endif
	OFT outv = rel;
