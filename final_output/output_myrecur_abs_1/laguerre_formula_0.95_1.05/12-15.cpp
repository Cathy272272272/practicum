...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = my_laguerre(15, x + 0.0);
	#else
	rel =  (  (  (  (  ( log( ( exp( (  (  (  ( pow( (  (  ( 1.0+ ( -15.0*x )  ) + ( 52.5* ( x*x )  )  ) + ( pow(x,3)* (  ( 56.875*x ) +-75.833333 )  )  ) ,3)+ (  (  ( -25.025* (  (  (  ( x*x ) *x ) *x ) *x )  ) * ( -25.025* (  (  (  ( x*x ) *x ) *x ) *x )  )  ) * ( -25.025* (  (  (  ( x*x ) *x ) *x ) *x )  )  )  ) * (  (  (  ( pow(x,3)* ( -75.833333+ ( 56.875*x )  )  ) + (  (  ( x*52.5 ) *x ) + (  ( x*-15.0 ) +1.0 )  )  ) * (  (  ( -25.025*x ) * ( x*x )  ) - ( x*x )  )  ) + (  ( pow(x,3)* ( -75.833333+ ( 56.875*x )  )  ) + (  (  ( x*52.5 ) *x ) + (  ( x*-15.0 ) +1.0 )  )  )  )  ) + (  (  ( x*x ) * (  ( -25.025*x ) * ( x*x )  )  ) * (  ( x*x ) * (  ( -25.025*x ) * ( x*x )  )  )  )  ) + ( 6.951389* (  (  (  (  ( x*x ) *x ) *x ) *x ) *x )  )  ) )*exp( ( -1.276786* (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x )  ) ) ) )+ ( 0.159598* (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -0.013792* (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 0.000828* (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -3.4e-05* (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 1e-06* (  (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
