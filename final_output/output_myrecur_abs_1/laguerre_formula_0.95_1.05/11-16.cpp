...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = my_laguerre(16, x + 0.0);
	#else
	rel =  (  (  (  (  (  (  ( x*x ) * ( x*x )  ) * ( pow(x,3)*pow(x,3) )  ) * (  ( x*-0.000109 ) +0.002207 )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( 0.319196+ ( -0.031526*x )  )  )  ) + (  (  ( cbrt( (  (  (  ( pow(x,3)*x ) * ( 75.833333+ ( -36.4*x )  )  ) + (  ( pow(x,3)*pow(x,3) ) * ( 11.122222+ ( -2.269841*x )  )  )  ) + (  ( x*x ) * ( 60.0+ ( -93.333333*x )  )  )  ) )*cbrt( (  (  (  ( pow(x,3)*x ) * ( 75.833333+ ( -36.4*x )  )  ) + (  ( pow(x,3)*pow(x,3) ) * ( 11.122222+ ( -2.269841*x )  )  )  ) + (  ( x*x ) * ( 60.0+ ( -93.333333*x )  )  )  ) ) ) *cbrt( (  (  (  ( pow(x,3)*x ) * ( 75.833333+ ( -36.4*x )  )  ) + (  ( pow(x,3)*pow(x,3) ) * ( 11.122222+ ( -2.269841*x )  )  )  ) + (  ( x*x ) * ( 60.0+ ( -93.333333*x )  )  )  ) ) ) + (  ( x*-16.0 ) +1.0 )  )  ) + (  (  ( 4e-06*x ) * ( x*x )  ) * (  ( pow(x,3)*pow(x,3) ) *pow(x,3) )  )  ) ;
	#endif
	OFT outv = rel;
