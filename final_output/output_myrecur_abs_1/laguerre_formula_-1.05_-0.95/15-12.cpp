...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*-0.157143 ) +1.283333 ) *pow(x, ( 2*3 ) ) ) + (  ( x*-12.0 ) +1.0 )  ) + (  (  ( -0.000606*x ) +0.012277 ) * ( pow(x,4)*pow(x,4) )  )  ) + (  (  (  ( pow(x,4)*1.8e-05 ) *pow( ( x*x ) ,3) ) + (  (  ( x*-6.6 ) +20.625 ) *pow(x, ( 2+2 ) ) )  ) + (  (  ( -36.666667*x ) +33.0 ) * ( x*x )  )  )  ) ;
	#endif
	OFT outv = rel;
