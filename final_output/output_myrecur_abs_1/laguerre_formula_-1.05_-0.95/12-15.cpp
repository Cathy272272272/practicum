...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  ( x*x ) * ( x*x )  ) * (  (  ( 0.000828+ ( -3.4e-05*x )  ) * ( pow(x,4)* ( x*x )  )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x*-0.013792 ) +0.159598 )  )  )  ) + (  (  (  (  (  ( -1.276786*x ) +6.951389 ) *pow(x,6) ) + ( pow(x, ( 2+2 ) )* ( 56.875+ ( x*-25.025 )  )  )  ) + (  ( 1.0+ ( -15.0*x )  ) + ( pow(pow(x,3), ( 1+3 ) )*1e-06 )  )  ) + (  (  ( -75.833333*x ) +52.5 ) * ( x*x )  )  )  ) ;
	#endif
	OFT outv = rel;
