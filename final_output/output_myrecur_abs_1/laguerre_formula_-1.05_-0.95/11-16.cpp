...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( 0.319196+ ( -0.031526*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( x*x ) * ( x*x )  )  ) + (  (  (  (  ( -0.000109*x ) +0.002207 ) * ( x*x )  ) * (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  ) + (  ( pow(x,6)* ( 11.122222+ ( x*-2.269841 )  )  ) + ( pow(x, ( 2+2 ) )* ( 75.833333+ ( x*-36.4 )  )  )  )  )  ) + (  (  (  ( 60.0+ ( -93.333333*x )  ) * ( x*x )  ) + ( 1.0+ ( x*-16.0 )  )  ) + (  (  ( x*x ) * ( x*4e-06 )  ) *pow(pow(x,3),3) )  )  ) ;
	#endif
	OFT outv = rel;
