...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( 39.0+ ( x*-47.666667 )  ) * ( x*x )  ) + (  ( 7.9e-05* ( x*x )  ) *pow( ( x*x ) , ( 3+1 ) ) )  ) + ( pow( ( x*x ) , ( 3+1 ) )* (  (  ( x*-2e-06 ) * ( x*x )  ) + ( 0.03192+ ( -0.00197*x )  )  )  )  ) + (  (  ( 1.0+ ( x*-13.0 )  ) + ( pow(x,6)* ( 2.383333+ ( x*-0.340476 )  )  )  ) + (  (  ( x*-10.725 ) +29.791667 ) *cbrt(pow(x, ( 3* ( 3+1 )  ) )) )  )  ) ;
	#endif
	OFT outv = rel;
