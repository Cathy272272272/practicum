...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( x*x ) * ( x*x )  ) * ( 19372953600.0- ( 15498362880.0*pow(x,2) )  )  ) + (  (  (  ( 5535129600.0*pow( ( x*x ) , ( 3+1 ) ) ) + (  ( -8302694400.0* ( x*x )  ) +518918400.0 )  ) * (  (  ( -8302694400.0* ( x*x )  ) +518918400.0 ) - ( 5535129600.0* ( pow( ( x*x ) ,3)* ( x*x )  )  )  )  ) / (  (  (  ( x*x ) *-8302694400.0 ) +518918400.0 ) - (  (  ( x*x ) *5535129600.0 ) *pow( ( x*x ) ,3) )  )  )  ) + (  (  ( pow( ( x*x ) ,3)* (  ( x*x ) * ( x*x )  )  ) * ( -984023040.0+ ( x* ( 89456640.0*x )  )  )  ) + (  (  ( pow( ( x*x ) ,3)* (  ( x*x ) * ( x*x )  )  ) * (  ( x*x ) * ( x*x )  )  ) * ( -3932160.0+ (  ( x*x ) *65536.0 )  )  )  )  ) ;
	#endif
	OFT outv = rel;
