...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( pow(x,4)*-484323840.0 ) + ( x* ( x*242161920.0 )  )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) *322882560.0 )  )  ) +-17297280.0 ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  (  ( x*x ) *12300288.0 ) +-92252160.0 )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( x*x ) * ( x*x )  )  ) * ( -745472.0+ ( 16384.0* ( x*x )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
