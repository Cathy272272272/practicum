...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( x*-16.0 ) + (  ( x*x ) * ( 60.0- ( 93.333333*x )  )  )  ) + (  (  ( pow(x,3)*pow(x,3) ) * (  ( x*-2.269841 ) +11.122222 )  ) +1.0 )  ) + (  ( pow(x,3)*pow(x,3) ) * (  (  ( 0.002207+ ( -0.000109*x )  ) * (  ( x*x ) * ( x*x )  )  ) + (  ( 4e-06* ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  )  )  ) + (  (  (  ( 0.319196+ ( x*-0.031526 )  ) *pow(x,4) ) + ( 75.833333+ ( -36.4*x )  )  ) * (  ( x*x ) * ( x*x )  )  )  ) ;
	#endif
	OFT outv = rel;
