...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( -9.997619*x ) * ( pow(x,3)*pow(x,3) )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) *37.683333 )  )  ) + (  (  (  (  ( -161.5*x ) * ( x*x )  ) +1.0 ) + ( x* ( -19.0+ ( x*85.5 )  )  )  ) + (  ( pow(x,3)* ( x*161.5 )  ) + (  ( -96.9*x ) * (  ( x*x ) * ( x*x )  )  )  )  )  ) + (  (  ( pow(x,3)*pow(x,3) ) * (  ( x*x ) *1.874554 )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( x*-0.254569 )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( x*x ) *0.025457 )  )  )  )  ) + (  (  (  (  ( pow(x,3)*pow(x,3) ) *pow(x,3) ) * (  ( x*x ) *-0.001893 )  ) + (  (  ( pow(x,3)*pow(x,3) ) * (  ( x*x ) * ( x*x )  )  ) * (  ( x*x ) *0.000105 )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( x*x ) * ( x*x )  )  ) * ( x*-4e-06 )  )  )  ) ;
	#endif
	OFT outv = rel;
