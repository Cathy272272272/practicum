...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( pow(x,4)*-373.908691 ) + ( x* ( x*21.994629 )  )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) *2368.088379 )  )  ) +-0.209473 ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  (  ( x*x ) *10893.206543 ) +-7104.265137 )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( x*x ) * ( x*x )  )  ) * ( -8252.429199+ ( 2448.522949* ( x*x )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
