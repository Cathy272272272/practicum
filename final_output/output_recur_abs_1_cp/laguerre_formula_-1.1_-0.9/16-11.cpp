...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  ( pow( ( x*x ) ,3)* ( 0.641667+ ( x*-0.065476 )  )  ) +log(pow(pow(exp(x),pow(x,3)), (  ( x*-3.85 ) +13.75 ) )) ) + (  ( pow(x,8)*0.004092 ) + (  ( 3e-06*x ) *pow(pow(x,3),3) )  )  ) - (  (  ( 0.000152*pow(x,9) ) - (  ( -11.0*x ) +1.0 )  ) - (  ( x*x ) * ( 27.5+ ( x*-27.5 )  )  )  )  ) ;
	#endif
	OFT outv = rel;
