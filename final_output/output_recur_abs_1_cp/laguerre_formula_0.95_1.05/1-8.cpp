...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  ( pow( ( x*x ) ,3)* ( 2.5e-05* ( x*x )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) * ( x*x )  ) * (  ( -0.001587*x ) +0.038889 )  )  ) +log( ( pow(pow(pow(exp(x),pow(x,3)),sqrt( (  ( x*-0.466667 ) +2.916667 ) )),sqrt( (  ( x*-0.466667 ) +2.916667 ) ))* ( exp( ( 1.0+ ( -8.0*x )  ) )*pow(exp( ( x*x ) ), (  ( x*-9.333333 ) +14.0 ) ) )  ) ) ) ;
	#endif
	OFT outv = rel;
