...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = __libcpp_generalized_laguerre_recurrence(8, x + 0.0);
	#else
	rel =  (  (  ( pow( ( x*x ) ,3)* ( 2.5e-05* ( x*x )  )  ) + ( pow( ( x*x ) ,3)* (  ( -0.001587*x ) +0.038889 )  )  ) +pow(exp( ( cbrt(log( ( log(pow(pow(exp(x),pow(x,3)), (  ( x*-0.466667 ) +2.916667 ) ))+ (  (  (  ( -9.333333*x ) +14.0 ) * ( x*x )  ) + ( 1.0+ ( x*-8.0 )  )  )  ) ))*cbrt(log( ( log(pow(pow(exp(x),pow(x,3)), (  ( x*-0.466667 ) +2.916667 ) ))+ (  (  (  ( -9.333333*x ) +14.0 ) * ( x*x )  ) + ( 1.0+ ( x*-8.0 )  )  )  ) )) ) ),cbrt(log( ( log(pow(pow(exp(x),pow(x,3)), (  ( x*-0.466667 ) +2.916667 ) ))+ (  (  (  ( -9.333333*x ) +14.0 ) * ( x*x )  ) + ( 1.0+ ( x*-8.0 )  )  )  ) ))) ) ;
	#endif
	OFT outv = rel;
