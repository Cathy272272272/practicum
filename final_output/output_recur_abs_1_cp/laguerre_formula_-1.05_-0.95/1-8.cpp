...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  ( pow( ( x*x ) ,3)* ( 2.5e-05* ( x*x )  )  ) + ( pow( ( x*x ) ,3)* (  ( -0.001587*x ) +0.038889 )  )  ) + (  ( cbrt( (  (  ( pow(x,3)*pow(x,3) ) * ( 14.0+ ( x*-9.333333 )  )  ) * (  ( 14.0+ ( x*-9.333333 )  ) * ( 14.0+ ( x*-9.333333 )  )  )  ) )+ (  (  ( x*x ) * ( x*x )  ) * ( 2.916667+ ( -0.466667*x )  )  )  ) + (  ( x*-8.0 ) +1.0 )  )  ) ;
	#endif
	OFT outv = rel;
