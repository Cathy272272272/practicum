...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  ( pow( ( x*x ) ,3)* ( 2.5e-05* ( x*x )  )  ) + ( pow(x, ( 2*3 ) )* (  ( -0.001587*x ) +0.038889 )  )  ) + ( log(pow(pow(exp(x),pow(x,3)), (  ( x*-0.466667 ) +2.916667 ) ))+log( ( exp( ( 1.0+ ( -8.0*x )  ) )* ( pow(exp( ( x*x ) ), ( x*-9.333333 ) )*pow(exp( ( x*x ) ),14.0) )  ) ) )  ) ;
	#endif
	OFT outv = rel;
