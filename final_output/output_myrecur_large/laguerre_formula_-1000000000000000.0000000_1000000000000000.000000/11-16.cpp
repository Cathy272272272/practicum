...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  (  (  (  (  (  ( 1.0+ ( -16.0*x )  ) + ( 60.0* ( x*x )  )  ) + ( -93.333333* (  ( x*x ) *x )  )  ) + ( 75.833333* (  (  ( x*x ) *x ) *x )  )  ) + ( -36.4* (  (  (  ( x*x ) *x ) *x ) *x )  )  ) + ( 11.122222* (  (  (  (  ( x*x ) *x ) *x ) *x ) *x )  )  ) + ( -2.269841* (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 0.319196* (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -0.031526* (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 0.002207* (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -0.000109* (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 4e-06* (  (  (  (  (  (  (  (  ( pow(x,3)*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
