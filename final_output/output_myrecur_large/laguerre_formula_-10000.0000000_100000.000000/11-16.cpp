...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( 0.002207* ( x*x )  )  ) + (  (  (  (  ( x*-16.0 ) +1.0 ) + (  ( x*x ) * (  ( -93.333333*x ) +60.0 )  )  ) + (  (  ( pow(x,3)*pow(x,3) ) * ( 11.122222+ ( -2.269841*x )  )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x*-36.4 ) +75.833333 )  )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( 0.319196+ ( -0.031526*x )  )  ) + (  (  ( pow(x,3)*pow(x,3) ) * (  ( x*x ) * ( x*x )  )  ) * (  ( 4e-06* ( x*x )  ) + ( x*-0.000109 )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
