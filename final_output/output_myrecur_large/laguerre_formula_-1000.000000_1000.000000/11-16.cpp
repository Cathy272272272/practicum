...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  ( 4e-06* ( x*x )  ) * (  ( pow(x,3)*pow(x,3) ) * (  ( x*x ) * ( x*x )  )  )  ) + (  ( pow(x,3)* ( pow(x,3)*pow(x,3) )  ) * (  ( -0.000109* ( x*x )  ) + ( 0.002207*x )  )  )  ) + (  (  (  ( -36.4*pow(x,5) ) +1.0 ) + (  (  (  ( x*60.0 ) +-16.0 ) *x ) + ( pow(x,3)* ( -93.333333+ ( 75.833333*x )  )  )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( -0.031526*x ) +0.319196 )  ) + (  ( pow(x,3)*pow(x,3) ) * (  ( -2.269841*x ) +11.122222 )  )  )  )  ) ;
	#endif
	OFT outv = rel;
