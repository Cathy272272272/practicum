...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = my_laguerre(19, x + 0.0);
	#else
	rel =  (  (  (  (  (  (  (  (  (  (  (  (  ( 1.0+ ( -19.0*x )  ) + ( 85.5* ( x*x )  )  ) + (  ( cbrt( ( -161.5* (  ( x*x ) *x )  ) )*cbrt( ( -161.5* (  ( x*x ) *x )  ) ) ) *cbrt( ( -161.5* (  ( x*x ) *x )  ) ) )  ) + ( 161.5* (  (  ( x*x ) *x ) *x )  )  ) + ( -96.9* (  (  (  ( x*x ) *x ) *x ) *x )  )  ) + ( 37.683333* (  (  (  (  ( x*x ) *x ) *x ) *x ) *x )  )  ) + ( -9.997619* (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 1.874554* (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -0.254569* (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 0.025457* (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -0.001893* (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 0.000105* (  (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -4e-06* (  (  (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
