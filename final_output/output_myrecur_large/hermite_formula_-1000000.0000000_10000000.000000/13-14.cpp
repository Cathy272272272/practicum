...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  ( -17297280.0+ ( 242161920.0* ( x*x )  )  ) + ( -484323840.0* (  (  ( x*x ) *x ) *x )  )  ) + ( 322882560.0* (  (  (  (  ( x*x ) *x ) *x ) *x ) *x )  )  ) + ( -92252160.0* (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + (  ( cbrt( (  (  ( 12300288.0*x ) *x ) *pow( ( x*x ) , ( 3+1 ) ) ) )*cbrt( (  (  ( 12300288.0*x ) *x ) *pow( ( x*x ) , ( 3+1 ) ) ) ) ) *cbrt( (  ( pow(x,3)* ( 12300288.0*x )  ) * ( pow(x,3)*pow(x,3) )  ) ) )  ) + ( -745472.0* (  (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 16384.0* (  (  (  (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
