...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( pow(x,3)*pow(x,3) ) * ( pow(x,3)*pow(x,3) )  ) * ( -745472.0+ ( x* ( 16384.0*x )  )  )  ) + (  ( x* ( 242161920.0*x )  ) + ( pow(x,4)*-484323840.0 )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * ( 322882560.0* ( x*x )  )  ) +-17297280.0 ) + (  (  (  ( 12300288.0*x ) *x ) +-92252160.0 ) *pow( ( x*x ) , ( 3+1 ) ) )  )  ) ;
	#endif
	OFT outv = rel;
