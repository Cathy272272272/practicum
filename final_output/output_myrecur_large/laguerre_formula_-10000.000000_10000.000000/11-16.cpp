...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  ( x*x ) * ( x*x )  ) * ( pow(x,3)*pow(x,3) )  ) * (  ( x*-0.000109 ) +0.002207 )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( 0.319196+ ( -0.031526*x )  )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * ( 75.833333+ ( -36.4*x )  )  ) + (  ( pow(x,3)*pow(x,3) ) * ( 11.122222+ ( -2.269841*x )  )  )  ) + ( exp( ( log( ( x*x ) )+log( ( 60.0+ ( -93.333333*x )  ) ) ) )+ (  ( x*-16.0 ) +1.0 )  )  )  ) + (  (  ( 4e-06*x ) * ( x*x )  ) * (  ( pow(x,3)*pow(x,3) ) *pow(x,3) )  )  ) ;
	#endif
	OFT outv = rel;
