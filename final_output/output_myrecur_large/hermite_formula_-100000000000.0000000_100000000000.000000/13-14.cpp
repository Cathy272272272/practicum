...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  ( -17297280.0+ ( 242161920.0* ( x*x )  )  ) + ( pow( ( x*x ) , ( 3+1 ) )* ( -92252160.0+ ( 12300288.0* ( x*x )  )  )  )  ) + (  (  ( -484323840.0+ (  ( x*322882560.0 ) *x )  ) * (  ( x*x ) * ( x*x )  )  ) + (  (  (  ( x*x ) *pow(x,3) ) * (  ( x*x ) *pow(x,3) )  ) * (  (  ( 16384.0*x ) *pow(x,3) ) + (  ( x*x ) *-745472.0 )  )  )  )  ) ;
	#endif
	OFT outv = rel;
