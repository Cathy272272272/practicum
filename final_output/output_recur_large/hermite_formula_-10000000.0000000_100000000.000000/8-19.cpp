...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) * ( x*x )  ) * ( pow(x,3)* ( pow(x,3)*pow(x,3) )  )  ) * (  ( x* ( 1524105216.0*x )  ) +-26671841280.0 )  ) + (  (  ( cbrt( (  ( x* ( 524288.0*x )  ) +-44826624.0 ) )*x ) * ( pow( (  ( x*x ) * ( x*x )  ) , ( 1+3 ) )*cbrt( (  ( x* ( 524288.0*x )  ) +-44826624.0 ) ) )  ) *cbrt( (  ( x* ( 524288.0*x )  ) +-44826624.0 ) ) )  ) + (  (  (  ( pow(x,3)* ( pow(x,3)*pow(x,3) )  ) * (  ( 260050452480.0* ( x*x )  ) +-1430277488640.0 )  ) + ( -670442572800.0*x )  ) + (  (  ( x*x ) * (  (  ( x*-6436248698880.0 ) * ( x*x )  ) + ( 4022655436800.0*x )  )  ) + (  (  ( 4290832465920.0*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
