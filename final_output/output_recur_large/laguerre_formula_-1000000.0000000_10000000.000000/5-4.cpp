...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = __libcpp_generalized_laguerre_recurrence(4, x + 0.0);
	#else
	rel =  (  ( pow(x,3)* (  ( 0.041667*x ) +-0.666667 )  ) + (  ( pow( (  ( x*3.0 ) *x ) ,3)+pow( (  ( x*-4.0 ) +1.0 ) ,3) ) / (  (  ( x* ( x*3.0 )  ) * ( x* ( x*3.0 )  )  ) + (  (  ( 1.0+ ( -4.0*x )  ) - ( x* ( x*3.0 )  )  ) * ( 1.0+ ( -4.0*x )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
