...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  (  ( 1.0+ ( -8.0*x )  ) + ( 14.0* ( x*x )  )  ) + ( -9.333333* (  ( x*x ) *x )  )  ) + ( 2.916667* (  (  ( x*x ) *x ) *x )  )  ) + ( -0.466667* (  (  (  ( x*x ) *x ) *x ) *x )  )  ) + ( 0.038889* (  (  (  (  ( x*x ) *x ) *x ) *x ) *x )  )  ) + ( -0.001587* (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 2.5e-05* (  (  (  ( cbrt(pow(pow(x,3), ( 1+3 ) ))*x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
