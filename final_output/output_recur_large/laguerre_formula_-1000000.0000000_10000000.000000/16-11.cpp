...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( 3e-06*x ) * ( x*x )  ) * ( pow(x,4)*pow(x,3) )  ) + (  (  (  ( x*x ) * ( x*x )  ) *exp( ( log( ( x*x ) )+log( ( x*x ) ) ) ) ) * ( 0.004092+ ( -0.000152*x )  )  )  ) + (  (  (  ( pow(x,3)*pow(x,3) ) * ( 0.641667+ ( -0.065476*x )  )  ) + (  (  ( x*x ) * ( x*x )  ) * ( 13.75+ ( -3.85*x )  )  )  ) + (  (  ( x*x ) * ( 27.5+ ( -27.5*x )  )  ) + (  ( x*-11.0 ) +1.0 )  )  )  ) ;
	#endif
	OFT outv = rel;
