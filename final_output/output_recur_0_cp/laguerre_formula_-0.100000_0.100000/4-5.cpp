...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = __libcpp_generalized_laguerre_recurrence(5, x + 0.0);
	#else
	rel =  ( sqrt( (  (  ( x*-5.0 ) +1.0 ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( -0.008333*x ) +0.208333 )  ) + (  ( x*x ) * (  ( -1.666667*x ) +5.0 )  )  )  ) )*sqrt( (  (  ( x*-5.0 ) +1.0 ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( -0.008333*x ) +0.208333 )  ) + (  ( x*x ) * (  ( -1.666667*x ) +5.0 )  )  )  ) ) ) ;
	#endif
	OFT outv = rel;
