...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( 3e-06*x ) *pow(x,3) ) * ( pow(x,3)*pow(x,3) )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x*-3.85 ) +13.75 )  )  ) + (  (  ( x*-0.000152 ) +0.004092 ) * (  (  ( x*x ) * ( x*x )  ) *pow(x,4) )  )  ) + (  (  ( -11.0*x ) +1.0 ) + (  (  ( pow(x,3)*pow(x,3) ) * ( 0.641667+ ( -0.065476*x )  )  ) + (  (  ( x*-27.5 ) +27.5 ) * ( x*x )  )  )  )  ) ;
	#endif
	OFT outv = rel;
