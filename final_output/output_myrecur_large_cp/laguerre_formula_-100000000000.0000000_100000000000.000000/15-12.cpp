...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( 1.8e-05*x ) *x ) * (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) *exp( ( log( ( x*x ) )+log( ( x*x ) ) ) ) ) * (  ( -0.000606*x ) +0.012277 )  )  ) + (  (  (  ( pow(x,3)*pow(x,3) ) * (  ( -0.157143*x ) +1.283333 )  ) + (  (  ( x*x ) * ( x*x )  ) * ( 20.625+ ( x*-6.6 )  )  )  ) + (  (  ( x*x ) * ( 33.0+ ( x*-36.666667 )  )  ) + (  ( x*-12.0 ) +1.0 )  )  )  ) ;
	#endif
	OFT outv = rel;
