...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( x*x ) * (  ( -36.666667*x ) +33.0 )  ) + (  ( x*-12.0 ) +1.0 )  ) + (  (  ( pow(x,3)*pow(x,3) ) * ( 1.283333+ ( -0.157143*x )  )  ) + (  (  ( x*x ) * ( x*x )  ) * ( 20.625+ ( -6.6*x )  )  )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( 1.8e-05* ( x*x )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) *pow(x, ( 2+2 ) ) ) * (  ( -0.000606*x ) +0.012277 )  )  )  ) ;
	#endif
	OFT outv = rel;
