...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  ( pow(x,3)* ( -9.997619*x )  ) *pow(x,3) ) + (  ( 37.683333* ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  ) + (  (  (  (  ( x* ( -0.254569+ ( 0.025457*x )  )  ) * (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  ) + ( pow( ( x*x ) ,3)* ( x* ( x*1.874554 )  )  )  ) + (  (  (  ( 1.0+ ( -19.0*x )  ) + ( 85.5* ( x*x )  )  ) + (  ( -161.5*x ) * ( x*x )  )  ) + (  (  ( x*161.5 ) *pow(x,3) ) + (  ( -96.9*x ) * (  ( x*x ) * ( x*x )  )  )  )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( x*x ) * (  ( x*x ) * ( x*-4e-06 )  )  )  ) + ( pow( ( x*x ) ,3)* (  (  ( x* ( 0.000105*x )  ) * (  ( x*x ) * ( x*x )  )  ) + (  (  ( x*x ) * ( x*x )  ) * ( -0.001893*x )  )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
