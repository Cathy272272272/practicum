...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) *242161920.0 ) +-17297280.0 ) + ( pow( ( x*x ) ,3)* ( x* ( -92252160.0*x )  )  )  ) + (  ( cbrt( (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*x ) *322882560.0 ) +-484323840.0 )  ) )*cbrt( (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*x ) *322882560.0 ) +-484323840.0 )  ) ) ) *cbrt( (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*x ) *322882560.0 ) +-484323840.0 )  ) ) )  ) + (  ( pow(x,14)*16384.0 ) + (  ( pow( ( x*x ) ,3)* (  ( x*x ) * ( x*x )  )  ) * ( 12300288.0+ ( x* ( -745472.0*x )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
