...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( x*x ) * (  ( -113.333333*x ) +68.0 )  ) + (  ( -17.0*x ) +1.0 )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*-51.566667 ) +99.166667 )  ) + (  ( pow(x,3)*pow(x,3) ) * ( 17.188889+ ( x*-3.85873 )  )  )  )  ) + (  (  (  ( 0.602927+ ( -0.066992*x )  ) * (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  ) + (  (  (  ( -0.00031*x ) +0.005359 ) * ( x*x )  ) * (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  )  ) + (  (  ( 1.3e-05*x ) * ( x*x )  ) *pow(pow(x,3),3) )  )  ) ;
	#endif
	OFT outv = rel;
