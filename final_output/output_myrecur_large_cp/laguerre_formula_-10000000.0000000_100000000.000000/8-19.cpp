...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( pow(x,3)* ( pow(x,3)* ( -9.997619*x )  )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) *37.683333 )  )  ) + ( 1.0+ (  ( x*x ) * ( x*-161.5 )  )  )  ) + (  (  ( x* (  ( 85.5*x ) +-19.0 )  ) + (  (  ( x*x ) * ( x*-96.9 )  ) * ( x*x )  )  ) + (  ( 161.5*x ) *pow(x,3) )  )  ) + (  (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( x* ( -0.254569+ ( 0.025457*x )  )  )  ) + (  ( pow(x,3)*pow(x,3) ) * (  ( x*x ) *1.874554 )  )  ) + (  ( pow(x,3)*pow(x,3) ) * (  (  (  ( x*x ) * ( x*x )  ) * ( -0.001893*x )  ) + (  (  ( x*x ) *0.000105 ) * (  ( x*x ) * ( x*x )  )  )  )  )  )  ) + ( pow(cbrt( (  ( x*x ) * ( x*x )  ) ),3)* (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( x*-4e-06 )  )  )  ) ;
	#endif
	OFT outv = rel;
