...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  ) * (  ( x* ( x*16384.0 )  ) +-745472.0 )  ) + (  (  (  ( x*242161920.0 ) *x ) +-17297280.0 ) + (  (  ( -484323840.0*x ) *pow(x,3) ) + (  (  ( x*x ) * ( x*x )  ) * ( x* ( 322882560.0*x )  )  )  )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( 12300288.0* ( x*x )  ) +-92252160.0 )  )  ) ;
	#endif
	OFT outv = rel;
