...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  ( 1.3e-05* ( x*x )  ) * (  ( pow(x,3)*pow(x,3) ) *pow(x, ( 2+2 ) ) )  ) + (  ( pow(x,3)* ( pow(x,3)*pow(x,3) )  ) * (  ( -0.00031* ( x*x )  ) + ( 0.005359*x )  )  )  ) + (  (  (  ( -51.566667*pow(x,5) ) +1.0 ) + (  (  (  ( x*68.0 ) +-17.0 ) *x ) + ( pow(x,3)* ( -113.333333+ ( 99.166667*x )  )  )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( -0.066992*x ) +0.602927 )  ) + (  ( pow(x,3)*pow(x,3) ) * (  ( -3.85873*x ) +17.188889 )  )  )  )  ) ;
	#endif
	OFT outv = rel;
