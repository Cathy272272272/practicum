...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( x* ( -0.254569+ ( 0.025457*x )  )  )  ) + ( pow( ( x*x ) ,3)* ( 1.874554* ( x*x )  )  )  ) + (  (  (  ( 1.0+ (  ( x*x ) * ( -161.5*x )  )  ) + (  ( -19.0+ ( x*85.5 )  ) *x )  ) + (  (  (  ( x*161.5 ) *pow(x,3) ) + (  ( x*x ) * (  ( x*x ) * ( -96.9*x )  )  )  ) + (  (  ( -9.997619*x ) *pow( ( x*x ) ,3) ) + (  (  ( 37.683333*x ) *x ) * (  ( x*x ) * ( x*x )  )  )  )  )  ) + (  (  ( pow(x, ( 2+2 ) )* ( x*-4e-06 )  ) * (  (  ( x*x ) *pow(x,4) ) * ( x*x )  )  ) + ( pow( ( x*x ) ,3)* (  (  (  ( x*x ) * ( x*x )  ) * ( -0.001893*x )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) *0.000105 )  )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
