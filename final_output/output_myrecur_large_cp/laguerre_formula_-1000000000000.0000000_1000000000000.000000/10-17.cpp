...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = my_laguerre(17, x + 0.0);
	#else
	rel =  (  (  (  (  (  (  (  (  (  (  (  ( 1.0+ ( -17.0*x )  ) + ( 68.0* ( x*x )  )  ) +cbrt(pow( (  (  ( -113.333333*x ) *x ) *x ) ,3)) ) + ( 99.166667* (  (  ( x*x ) *x ) *x )  )  ) + ( -51.566667* (  (  (  ( x*x ) *x ) *x ) *x )  )  ) + ( 17.188889* (  (  (  (  ( x*x ) *x ) *x ) *x ) *x )  )  ) + ( -3.85873* (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 0.602927* (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -0.066992* (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 0.005359* (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -0.00031* (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 1.3e-05* (  (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
