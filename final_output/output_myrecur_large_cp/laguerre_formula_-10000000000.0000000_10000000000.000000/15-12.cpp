...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) * ( x*x )  ) *pow(x, ( 2+2 ) ) ) * (  ( 1.8e-05* ( x*x )  ) + ( -0.000606*x )  )  ) + (  (  ( pow(x,4)*20.625 ) + (  ( x*-12.0 ) +1.0 )  ) + (  ( x*x ) * ( 33.0+ ( -36.666667*x )  )  )  )  ) + ( x* (  (  (  ( x*x ) * ( x*x )  ) * ( -6.6+ ( 1.283333*x )  )  ) + (  ( pow(x,3)*pow(x,3) ) * ( -0.157143+ ( x*0.012277 )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
