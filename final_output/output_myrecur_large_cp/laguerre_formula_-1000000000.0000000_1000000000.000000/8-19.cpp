...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) * ( -161.5*x )  ) + (  ( 1.0+ ( -19.0*x )  ) + (  ( x*x ) *85.5 )  )  ) + (  (  ( x*161.5 ) *pow(x,3) ) + (  (  ( x*x ) * ( -96.9*x )  ) * ( x*x )  )  )  ) + (  (  (  ( pow(x,3)* ( -9.997619*x )  ) *pow(x,3) ) + (  (  ( 37.683333*x ) *x ) * (  ( x*x ) * ( x*x )  )  )  ) + ( pow( ( x*x ) ,3)* ( x* ( 1.874554*x )  )  )  )  ) + (  (  ( x* ( -0.254569+ ( 0.025457*x )  )  ) * (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*x ) * ( x*x )  ) * (  ( x*-4e-06 ) *pow(x,4) )  )  ) + ( pow( ( x*x ) ,3)* (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) *0.000105 )  ) + (  (  ( x*x ) * ( x*x )  ) * ( -0.001893*x )  )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
