...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = my_laguerre(12, x + 0.0);
	#else
	rel =  (  (  (  (  ( x*-0.000606 ) +0.012277 ) *pow( ( x*x ) , ( 1+3 ) ) ) + (  (  ( cbrt( (  (  ( x*-36.666667 ) +33.0 ) * ( x*x )  ) )*cbrt( (  (  ( x*-36.666667 ) +33.0 ) * ( x*x )  ) ) ) *cbrt( (  (  ( x*-36.666667 ) +33.0 ) * ( x*x )  ) ) ) + (  ( -12.0*x ) +1.0 )  )  ) + (  (  ( pow(x,3)*pow(x,3) ) * ( 1.8e-05*pow(x,4) )  ) + (  (  ( 1.283333+ ( -0.157143*x )  ) * ( pow(x,3)*pow(x,3) )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x*-6.6 ) +20.625 )  )  )  )  ) ;
	#endif
	OFT outv = rel;
