...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  ( -17297280.0+ ( 242161920.0* ( x*x )  )  ) + ( -484323840.0* (  (  ( x*x ) *x ) *x )  )  ) + ( 322882560.0* (  (  (  (  ( x*x ) *x ) *x ) *x ) *x )  )  ) + ( -92252160.0* (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + (  (  ( 12300288.0*x ) *pow( ( x*x ) , ( 1+3 ) ) ) *x )  ) + (  ( pow(pow( ( x*x ) , ( cbrt( ( 1+3 ) )*cbrt( ( 1+3 ) ) ) ),cbrt( ( 1+3 ) ))* (  ( -745472.0*x ) * ( x*x )  )  ) *x )  ) + ( 16384.0* (  (  (  (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
