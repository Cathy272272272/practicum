...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = my_legendre(7, x + 0.0);
	#else
	rel =  (  ( cbrt( (  (  ( x*pow(x,4) ) * ( -43.3125+ (  ( x*26.8125 ) *x )  )  ) + (  ( x*-2.1875 ) + (  ( x*x ) * ( 19.6875*x )  )  )  ) )*cbrt(log( (  ( exp( ( 26.8125*pow(x,7) ) )*exp( ( 19.6875*pow(x,3) ) ) ) /exp( (  ( 43.3125*pow(x,5) ) + ( 2.1875*x )  ) ) ) )) ) *cbrt( (  ( x* (  (  ( 19.6875*x ) *x ) +-2.1875 )  ) + (  ( x*pow(x,4) ) * (  ( x* ( 26.8125*x )  ) +-43.3125 )  )  ) ) ) ;
	#endif
	OFT outv = rel;
