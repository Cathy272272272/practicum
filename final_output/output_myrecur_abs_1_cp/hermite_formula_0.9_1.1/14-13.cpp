...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  ( x* (  (  (  (  ( x*x ) *pow(x,3) ) * (  ( x*x ) *pow(x,3) )  ) * (  ( 8192.0* ( x*x )  ) +-319488.0 )  ) + (  (  (  ( 4392960.0*x ) *pow(x,3) ) *cbrt(pow(x,8)) ) *cbrt( (  ( x*x ) * ( x*x )  ) ) )  )  ) + (  (  ( 17297280.0*x ) + (  (  ( -26357760.0*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  )  ) + (  ( x*x ) * (  ( -69189120.0*x ) + (  ( 69189120.0*x ) * ( x*x )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
