...
int main (int argc, char *argv[]) {
    ...
    FT x = in_x;
	#ifdef ORIG
	rel = my_hermite(10, x + 0.0);
	#else
	rel =  (  (  ( cbrt( (  (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*x ) *161280.0 ) +-403200.0 )  ) + (  (  (  ( x*x ) *302400.0 ) +-30240.0 ) + (  (  ( x*x ) *-23040.0 ) *pow( ( x*x ) ,3) )  )  ) )*cbrt( (  (  (  (  (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*x ) *161280.0 ) +-403200.0 )  ) * (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) *161280.0 )  )  ) + (  (  (  ( pow(x,3)*pow(x,3) ) * ( -403200.0* ( x*x )  )  ) * (  ( x* ( 161280.0*x )  ) +-403200.0 )  ) - (  (  ( 302400.0* ( x*x )  ) +-30240.0 ) * (  ( 302400.0* ( x*x )  ) +-30240.0 )  )  )  ) / (  (  (  ( x*x ) * ( x*x )  ) * (  (  ( x*x ) *161280.0 ) +-403200.0 )  ) - (  (  ( x*x ) *302400.0 ) +-30240.0 )  )  ) + (  (  ( x*x ) *-23040.0 ) *pow( ( x*x ) ,3) )  ) ) ) *cbrt( (  ( -30240.0+ (  (  ( x*-403200.0 ) *pow(x,3) ) + ( x* ( x*302400.0 )  )  )  ) + (  ( pow(x,3)*pow(x,3) ) * (  (  ( x*x ) *-23040.0 ) +161280.0 )  )  ) ) ) + ( 1024.0* (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
