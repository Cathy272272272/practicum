...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( pow(x,4)* ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( 0.000276+ ( x*-9e-06 )  )  ) + (  (  ( 0.074479+ ( -0.005517*x )  ) *pow( ( x*x ) , ( 3+1 ) ) ) + (  ( 45.5+ ( -60.666667*x )  ) * ( x*x )  )  )  ) + (  (  (  ( x*-14.0 ) +1.0 ) + ( pow(x, ( 2+2 ) )* ( 41.708333+ ( x*-16.683333 )  )  )  ) + (  ( pow(-1,-6)*pow( ( -1/x ) ,-6) ) * ( 4.170833- ( 0.680952*x )  )  )  )  ) ;
	#endif
	OFT outv = rel;
