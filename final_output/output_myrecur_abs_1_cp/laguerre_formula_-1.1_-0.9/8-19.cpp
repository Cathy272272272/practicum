...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( pow(x,3)*pow(x,3) ) * ( 1.874554* ( x*x )  )  ) + (  (  ( x*x ) *pow(x,8) ) *0.025457 )  ) + (  (  (  ( x*-0.254569 ) * ( x*x )  ) *pow(x,6) ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x* ( 37.683333*x )  ) + (  ( x*-9.997619 ) * ( x*x )  )  )  )  )  ) + (  (  ( pow( ( x*x ) , ( 3+1 ) )* (  ( pow(x,3)* ( x*0.000105 )  ) + (  ( x*-0.001893 ) * ( x*x )  )  )  ) + (  ( pow( ( 1/x ) ,-6)* (  ( x*x ) * ( x*x )  )  ) * (  ( x*x ) * ( x*-4e-06 )  )  )  ) + (  (  (  ( x*x ) * (  ( x*x ) * ( x*-96.9 )  )  ) + (  ( -19.0*x ) +1.0 )  ) + (  (  (  ( x*x ) * ( x*-161.5 )  ) + (  ( x*161.5 ) *pow(x,3) )  ) + ( x* ( x*85.5 )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
