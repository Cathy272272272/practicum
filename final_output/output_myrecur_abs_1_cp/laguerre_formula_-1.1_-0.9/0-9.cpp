...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( x*-3e-06 ) +0.000223 ) *pow( ( x*x ) , ( 3+1 ) ) ) + (  (  (  ( cbrt( (  ( x*x ) * ( x*x )  ) )*sqrt(cbrt( (  ( x*x ) * ( x*x )  ) )) ) *sqrt(cbrt( (  ( x*x ) * ( x*x )  ) )) ) *cbrt( (  ( x*x ) * ( x*x )  ) ) ) * (  ( 0.116667* ( x*x )  ) + ( 5.25+ ( x*-1.05 )  )  )  )  ) + (  ( 1.0+ ( -9.0*x )  ) + (  ( x*x ) * (  ( 18.0+ ( -14.0*x )  ) + ( pow(x,4)* ( x*-0.007143 )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
