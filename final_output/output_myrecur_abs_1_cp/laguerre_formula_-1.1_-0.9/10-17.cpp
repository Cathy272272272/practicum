...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  (  ( x*-0.066992 ) +0.602927 ) + ( pow(x,3)* ( 1.3e-05*x )  )  )  ) + (  (  ( 99.166667+ ( -51.566667*x )  ) *pow(x,4) ) + ( pow(x, ( 3+3 ) )* (  ( -3.85873*x ) +17.188889 )  )  )  ) + (  (  ( -17.0*x ) + (  ( 0.005359+ ( -0.00031*x )  ) * ( pow(x,8)* ( x*x )  )  )  ) + (  (  ( 68.0+ ( -113.333333*x )  ) * ( x*x )  ) +1.0 )  )  ) ;
	#endif
	OFT outv = rel;
