...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( x*x ) * ( x*x )  ) * (  (  (  ( x*-9e-06 ) +0.000276 ) * ( pow(x,3)*pow(x,3) )  ) + ( pow(x,4)* ( 0.074479+ ( -0.005517*x )  )  )  )  ) + (  ( pow(x,3)*pow(x,3) ) * ( 4.170833+ ( x*-0.680952 )  )  )  ) + (  (  ( 1.0+ ( x*-14.0 )  ) + (  ( 45.5+ ( x*-60.666667 )  ) * ( x*x )  )  ) + (  (  ( x*-16.683333 ) +41.708333 ) *cbrt(pow(pow(x,3), ( 3+1 ) )) )  )  ) ;
	#endif
	OFT outv = rel;
