...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  ( cbrt(pow(x, ( 3+ ( 3*3 )  ) ))* (  ( x*-10.725 ) +29.791667 )  ) + ( pow(x,6)* ( 2.383333+ ( x*-0.340476 )  )  )  ) + (  (  (  (  ( 0.03192+ ( -0.00197*x )  ) *pow(x,4) ) + (  (  ( -2e-06*x ) +7.9e-05 ) *pow( ( x*x ) ,3) )  ) * (  ( x*x ) * ( x*x )  )  ) + (  (  (  ( x*-47.666667 ) +39.0 ) * ( x*x )  ) + ( 1.0+ ( -13.0*x )  )  )  )  ) ;
	#endif
	OFT outv = rel;
