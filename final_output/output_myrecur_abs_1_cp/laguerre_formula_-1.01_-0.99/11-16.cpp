...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( x*-16.0 ) +1.0 ) + (  ( 75.833333+ ( -36.4*x )  ) *pow(x,4) )  ) + (  ( 60.0+ ( x*-93.333333 )  ) * ( x*x )  )  ) + (  (  (  ( pow(x,3)*pow(x,3) ) * ( 11.122222+ ( -2.269841*x )  )  ) + (  (  (  ( x*-0.000109 ) +0.002207 ) * ( x*x )  ) * ( pow(x,4)* (  ( x*x ) * ( x*x )  )  )  )  ) + ( pow(x,3)* (  (  (  ( x*x ) *pow(x,3) ) * ( 0.319196+ ( x*-0.031526 )  )  ) + (  (  ( 4e-06*x ) * ( x*x )  ) * ( pow(x,3)*pow(x,3) )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
