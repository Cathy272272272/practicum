...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  ( 0.000105*x ) *pow(x,3) ) *pow( ( x*x ) , ( 3+1 ) ) ) + ( pow( ( x*x ) , ( 3+1 ) )* (  ( x*-0.001893 ) * ( x*x )  )  )  ) + ( pow( ( x*x ) , ( 3+1 ) )* (  (  ( x*x ) * ( x*x )  ) * ( x*-4e-06 )  )  )  ) + (  (  (  ( x* ( 37.683333*x )  ) * (  ( x*x ) * ( x*x )  )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*-9.997619 )  )  )  ) + (  (  ( 161.5*x ) *pow(x,3) ) + (  ( x*-96.9 ) * (  ( x*x ) * ( x*x )  )  )  )  )  ) + (  (  (  (  ( x*-161.5 ) * ( x*x )  ) + ( 85.5* ( x*x )  )  ) + ( 1.0+ ( x*-19.0 )  )  ) + (  (  (  ( 0.025457*x ) *pow(x,3) ) * ( pow(x,3)*pow(x,3) )  ) + (  (  (  ( x*x ) *1.874554 ) *pow( ( 1/x ) ,-6) ) + ( pow(x,8)* ( x*-0.254569 )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
