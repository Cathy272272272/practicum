...
int main (int argc, char *argv[]) {
	...
	#else
	rel = log( ( pow(pow(exp(x), (  ( x*x ) * ( x*x )  ) ), (  ( x* ( 26.8125*x )  ) +-43.3125 ) )*cbrt( ( sqrt(pow( ( exp(-2.1875)*pow(exp(19.6875), ( x*x ) ) ) , ( x+ ( x+x )  ) ))*sqrt( ( pow( ( exp(-2.1875)*pow(exp(19.6875), ( x*x ) ) ) ,x)*pow( ( exp(-2.1875)*pow(exp(19.6875), ( x*x ) ) ) , ( x+x ) ) ) ) ) ) ) );
	#endif
	OFT outv = rel;
