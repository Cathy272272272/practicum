...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( pow(x,3)* ( x*5.25 )  ) + (  ( x*-9.0 ) +1.0 )  ) - (  ( -1.05+ ( 0.116667*x )  ) * (  ( x*x ) *pow(x,3) )  )  ) * (  (  ( x*x ) * (  ( 18.0+ ( -14.0*x )  ) * (  ( -14.0*x ) -18.0 )  )  ) + (  (  (  ( pow(x,3)* ( x*5.25 )  ) + (  ( x*-9.0 ) +1.0 )  ) + (  ( -1.05+ ( 0.116667*x )  ) * (  ( x*x ) *pow(x,3) )  )  ) * (  ( -14.0*x ) -18.0 )  )  )  ) / (  (  (  ( 1.0+ ( -9.0*x )  ) + (  ( x*5.25 ) *pow(x,3) )  ) - (  ( -1.05+ ( x*0.116667 )  ) * ( pow(x,3)* ( x*x )  )  )  ) * (  ( -14.0*x ) -18.0 )  )  ) + (  (  (  ( -0.007143*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( -3e-06*x ) +0.000223 )  )  )  ) ;
	#endif
	OFT outv = rel;
