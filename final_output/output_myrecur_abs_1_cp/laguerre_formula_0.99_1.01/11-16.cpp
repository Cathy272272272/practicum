...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  ( log( ( pow(exp( ( x*x ) ), (  ( x*-93.333333 ) +60.0 ) )*exp( ( pow(x,4)* ( 75.833333- ( x*36.4 )  )  ) ) ) )+ (  (  ( 11.122222+ ( -2.269841*x )  ) * ( pow(x,3)*pow(x,3) )  ) + (  ( x*-16.0 ) +1.0 )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  (  (  ( -0.000109*x ) +0.002207 ) * ( pow(x,3)*pow(x,3) )  ) + (  ( 0.319196+ ( -0.031526*x )  ) * (  ( x*x ) * ( x*x )  )  )  )  ) + (  (  ( x*x ) * ( 4e-06*x )  ) *pow(pow(x,3),3) )  )  ) ;
	#endif
	OFT outv = rel;
