...
int main (int argc, char *argv[]) {
	...
	#else
	rel = cbrt(pow(cbrt(pow( ( sqrt( (  (  (  ( pow( ( x*x ) , ( 1+3 ) )*pow( ( x*x ) ,3) ) * (  ( x* ( x*65536.0 )  ) +-3932160.0 )  ) + (  (  ( x*x ) * ( x*x )  ) * ( 19372953600.0- ( 15498362880.0* ( x*x )  )  )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) *pow( ( x*x ) ,3) ) * (  ( 89456640.0* ( x*x )  ) +-984023040.0 )  ) + (  ( pow( ( x*x ) , ( 1+3 ) )*5535129600.0 ) + ( 518918400.0+ ( -8302694400.0* ( x*x )  )  )  )  )  ) )*sqrt( (  (  (  ( pow( ( x*x ) , ( 1+3 ) )*pow( ( x*x ) ,3) ) * (  ( x* ( x*65536.0 )  ) +-3932160.0 )  ) + (  (  ( x*x ) * ( x*x )  ) * ( 19372953600.0- ( 15498362880.0* ( x*x )  )  )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) *pow( ( x*x ) ,3) ) * (  ( 89456640.0* ( x*x )  ) +-984023040.0 )  ) + (  ( pow( ( x*x ) , ( 1+3 ) )*5535129600.0 ) + ( 518918400.0+ ( -8302694400.0* ( x*x )  )  )  )  )  ) ) ) ,3)),3));
	#endif
	OFT outv = rel;
