...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  ( -6.0*x ) +1.0 ) + (  (  ( x*x ) * ( x*x )  ) * (  ( x* ( x*0.001389 )  ) + ( 0.625+ ( -0.05*x )  )  )  )  ) +cbrt( (  (  (  ( pow( ( x*-3.333333 ) ,3)+pow(7.5,3) ) *pow(x, ( 2*3 ) ) ) / (  (  ( x*-3.333333 ) * ( x*-3.333333 )  ) + (  ( 7.5*7.5 ) - (  ( x*-3.333333 ) *7.5 )  )  )  ) * (  ( 56.25- ( x*49.999995 )  ) + ( x* ( x*11.111108888889001 )  )  )  ) ) ) ;
	#endif
	OFT outv = rel;
