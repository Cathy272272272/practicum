...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  ( cbrt( ( 1.0+ (  (  ( -6.0+ ( 7.5*x )  ) *x ) + ( pow(x,3)* (  ( 0.625*x ) +-3.333333 )  )  )  ) )*cbrt( ( 1.0+ (  (  ( -6.0+ ( 7.5*x )  ) *x ) + ( pow(x,3)* (  ( 0.625*x ) +-3.333333 )  )  )  ) ) ) *cbrt( ( 1.0+ (  (  ( -6.0+ ( 7.5*x )  ) *x ) + ( pow(x,3)* (  ( 0.625*x ) +-3.333333 )  )  )  ) ) ) + ( -0.05* (  (  (  ( x*x ) *x ) *x ) *x )  )  ) + ( 0.001389* (  (  (  (  ( x*x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
