...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) *0.291667 ) * (  ( x*x ) * ( x*x )  )  ) + (  (  ( x*x ) * ( x*x )  ) * (  ( -2.1*x ) +8.75 )  )  ) + (  (  ( x*-10.0 ) +1.0 ) +cbrt( (  (  ( pow(x,3)*pow(x,3) ) * ( 22.5+ ( x*-20.0 )  )  ) * (  ( 22.5+ ( x*-20.0 )  ) * ( 22.5+ ( x*-20.0 )  )  )  ) ) )  ) + (  (  (  ( -0.02381*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( -2.8e-05*x ) +0.001116 )  )  )  ) ;
	#endif
	OFT outv = rel;
