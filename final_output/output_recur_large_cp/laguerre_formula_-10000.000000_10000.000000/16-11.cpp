...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  ( cbrt( (  ( pow( ( x*x ) ,3)* ( 27.5+ ( -27.5*x )  )  ) * (  ( 27.5+ ( -27.5*x )  ) * ( 27.5+ ( -27.5*x )  )  )  ) )+ (  (  ( 1.0+ ( -11.0*x )  ) + (  ( pow( ( x*x ) ,3)* ( 0.641667+ ( -0.065476*x )  )  ) + (  (  ( x*x ) * ( x*x )  ) * ( 13.75+ ( x*-3.85 )  )  )  )  ) + (  (  ( x*x ) * ( x*x )  ) * (  (  (  ( x*-0.000152 ) +0.004092 ) *pow(x,4) ) + (  (  ( x*3e-06 ) *x ) * (  ( x*x ) * ( x*x )  )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
