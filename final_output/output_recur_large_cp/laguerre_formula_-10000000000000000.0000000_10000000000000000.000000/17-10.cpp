...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  (  (  ( 1.0+ ( -10.0*x )  ) + ( 22.5* ( x*x )  )  ) + ( -20.0* (  ( x*x ) *x )  )  ) + ( 8.75* (  (  ( x*x ) *x ) *x )  )  ) + ( -2.1* (  (  (  ( x*x ) *x ) *x ) *x )  )  ) + ( 0.291667* (  (  (  (  ( x*x ) *x ) *x ) *x ) *x )  )  ) + ( -0.02381* (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 0.001116* (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -2.8e-05* (  (  (  (  (  ( pow(x,3)*x ) *x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
