...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( 0.074479+ ( -0.005517*x )  )  ) + (  (  ( pow(x,3)*pow(x,3) ) * (  ( x*x ) * ( x*x )  )  ) * (  ( x*-9e-06 ) +0.000276 )  )  ) + (  (  (  ( x*x ) * (  ( -60.666667*x ) +45.5 )  ) + (  ( x*-14.0 ) +1.0 )  ) + (  (  ( pow(x,3)*pow(x,3) ) * ( 4.170833+ ( -0.680952*x )  )  ) + (  (  ( x*x ) * ( x*x )  ) * ( 41.708333+ ( x*-16.683333 )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
