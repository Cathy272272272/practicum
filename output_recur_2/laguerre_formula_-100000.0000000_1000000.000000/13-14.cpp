...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) * ( x*x )  ) * ( pow(x,3)*pow(x,3) )  ) * ( 0.000276+ ( x*-9e-06 )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) *pow(x, ( 2+2 ) ) ) * ( 0.074479+ ( -0.005517*x )  )  )  ) + (  (  (  ( pow(x,3)*pow(x,3) ) * (  ( -0.680952*x ) +4.170833 )  ) + (  ( x*-14.0 ) +1.0 )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( -16.683333*x ) +41.708333 )  ) + (  ( x*x ) * (  ( -60.666667*x ) +45.5 )  )  )  )  ) ;
	#endif
	OFT outv = rel;
