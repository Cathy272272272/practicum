...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  ( x*x ) * ( 52.5- ( 75.833333*x )  )  ) + ( pow(pow(x,3),3)* (  ( x*1e-06 ) * ( x*x )  )  )  ) + (  (  ( x*x ) * ( 0.000828- ( 3.4e-05*x )  )  ) *pow( ( x*x ) , ( 3+1 ) ) )  ) + (  (  (  (  ( x*-0.013792 ) +0.159598 ) *pow( ( x*x ) , ( 3+1 ) ) ) + (  (  ( x*x ) * ( x*x )  ) * ( 56.875+ ( -25.025*x )  )  )  ) + (  ( pow( ( x*x ) ,3)* (  ( x*-1.276786 ) +6.951389 )  ) + (  ( x*-15.0 ) +1.0 )  )  )  ) ;
	#endif
	OFT outv = rel;
