...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * (  ( x*x ) *0.000828 )  ) + (  ( -15.0*x ) +1.0 )  ) + (  (  (  ( 52.5+ ( x*-75.833333 )  ) * ( x*x )  ) + (  (  ( -25.025*x ) +56.875 ) * (  ( x*x ) * ( x*x )  )  )  ) + (  ( 6.951389+ ( -1.276786*x )  ) *pow(x,6) )  )  ) + (  (  (  (  ( x*x ) * ( x*x )  ) *pow( ( x*x ) ,3) ) * ( x* (  ( x*1e-06 ) +-3.4e-05 )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( 0.159598+ ( x*-0.013792 )  )  )  )  ) ;
	#endif
	OFT outv = rel;
