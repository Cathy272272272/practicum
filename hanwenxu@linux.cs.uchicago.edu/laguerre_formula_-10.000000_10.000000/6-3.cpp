...
int main (int argc, char *argv[]) {
    ...
    FT x;
	#ifdef ORIG
	rel = __libcpp_generalized_laguerre_recurrence(3, x);
	#else
	rel =  (  ( pow( (  ( 1.0+ ( -3.0*x )  ) + ( 1.5* ( x*x )  )  ) ,3)+pow( ( -0.166667* (  ( x*x ) *x )  ) ,3) ) / (  (  (  ( 1.0+ ( -3.0*x )  ) + ( 1.5* ( x*x )  )  ) * (  ( 1.0+ ( -3.0*x )  ) + ( 1.5* ( x*x )  )  )  ) + (  (  ( -0.166667* (  ( x*x ) *x )  ) * ( -0.166667* (  ( x*x ) *x )  )  ) - (  (  ( 1.0+ ( -3.0*x )  ) + ( 1.5* ( x*x )  )  ) * ( -0.166667* (  ( x*x ) *x )  )  )  )  )  ) ;
	#endif
	OFT outv = rel;
