...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  ( cbrt( (  (  ( pow(x,3)*pow(x,3) ) * ( 10.5+ ( -5.833333*x )  )  ) * (  ( 10.5+ ( -5.833333*x )  ) * ( 10.5+ ( -5.833333*x )  )  )  ) )+ (  ( x*-7.0 ) +1.0 )  ) + (  ( exp( ( log( ( x*x ) )+log( ( x*x ) ) ) )* ( 1.458333+ ( -0.175*x )  )  ) + (  (  ( pow(x,3)* ( x*x )  ) *x ) * (  ( -0.000198*x ) +0.009722 )  )  )  ) ;
	#endif
	OFT outv = rel;
