...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  ( pow(x, ( 2* ( 3+1 )  ) )* (  (  (  ( x*-9e-06 ) +0.000276 ) * ( x*x )  ) + ( 0.074479+ ( -0.005517*x )  )  )  ) + (  (  (  ( -14.0*x ) +1.0 ) + (  (  ( x*-60.666667 ) +45.5 ) * ( x*x )  )  ) + (  (  (  ( x*-0.680952 ) +4.170833 ) * ( pow(x,3)*pow(x,3) )  ) + (  ( pow(x,4)*41.708333 ) - ( pow(x,5)*16.683333 )  )  )  )  ) ;
	#endif
	OFT outv = rel;
