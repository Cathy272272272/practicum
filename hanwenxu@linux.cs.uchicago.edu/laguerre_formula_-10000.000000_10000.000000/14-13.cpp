...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  ( x*x ) * ( x*x )  ) * ( pow(x,3)*pow(x,3) )  ) * ( 7.9e-05+ ( x*-2e-06 )  )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( x*x ) * ( x*x )  )  ) * ( 0.03192+ ( -0.00197*x )  )  )  ) + (  (  (  ( pow(x,3)*pow(x,3) ) * (  ( -0.340476*x ) +2.383333 )  ) + (  ( x*-13.0 ) +1.0 )  ) + (  (  (  ( x*x ) * ( x*x )  ) * (  ( -10.725*x ) +29.791667 )  ) + (  (  ( x*x ) * ( -47.666667*x )  ) + (  ( x*x ) *39.0 )  )  )  )  ) ;
	#endif
	OFT outv = rel;
