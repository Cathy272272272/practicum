...
int main (int argc, char *argv[]) {
    ...
    FT x;
	#ifdef ORIG
	rel = __libcpp_generalized_laguerre_recurrence(7, x);
	#else
	rel =  (  (  (  (  ( 10.5*pow(x,2) ) + ( 0.5401233950617297*pow(x,4) )  ) - (  ( 59.548604305555735* ( pow(x,4)/pow(10.5,2) )  ) + ( 5.833332999999999*pow(x,3) )  )  ) + (  ( x*-7.0 ) +1.0 )  ) + (  (  (  ( x*x ) * ( x*x )  ) * ( 1.458333+ ( -0.175*x )  )  ) + (  ( pow(x,3)*pow(x,3) ) * (  ( -0.000198*x ) +0.009722 )  )  )  ) ;
	#endif
	OFT outv = rel;
