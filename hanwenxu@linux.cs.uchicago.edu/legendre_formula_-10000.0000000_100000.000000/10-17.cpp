...
int main (int argc, char *argv[]) {
	...
	#else
	rel =  (  (  (  (  (  (  (  (  ( 3.33847*x ) + ( -169.14917* (  ( x*x ) *x )  )  ) + ( 2486.492798* (  (  (  ( x*x ) *x ) *x ) *x )  )  ) + (  ( cbrt( ( -16339.809814* (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x )  ) )*cbrt( ( -16339.809814* (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x )  ) ) ) *cbrt( ( -16339.809814* (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x )  ) ) )  ) + ( 56735.450745* (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -111407.794189* (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 124262.539673* (  (  (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( -73374.071045* (  (  (  (  (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) + ( 17804.002533* (  (  (  (  (  (  (  (  (  (  (  (  (  (  (  ( x*x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x ) *x )  )  ) ;
	#endif
	OFT outv = rel;
