...
function end(x) {
	return (((((x * 2421619200.0) + ((x * -2905943040.0) * (x * x))) * (x * x)) + ((-1720320.0 + ((x * 32768.0) * x)) * (math.pow(x, 4.0) * math.pow(math.pow(x, 3.0), 3.0)))) + (((-307507200.0 + (x * (x * 33546240.0))) * math.pow(math.pow(x, 3.0), 3.0)) + ((((x * x) * (x * x)) * ((x * x) * (1383782400.0 * x))) + (-518918400.0 * x))));
}
